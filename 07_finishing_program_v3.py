...
def yes_no(question, no_response):
    valid = False
...
def print_instructions(yes_no_instruction):
    show_instruction = input(yes_no_instruction)
...
def questions_rand():
    ...
    user = ""
    exit_way = "xxx"
    while count_questions < how_much:
        # print current round num
        round_num = count_questions + 1
    ...
    print("You have got {} out of {}, and is {:.1f}% right among all questions!"
          .format(score, Total_score, score_percentage))
...
learn_jp_before_ques = yes_no("Have you learnt Japanese before? ",
                              "Maybe you have to guess the Roman script of the Hiragana characters. Good luck then!! ")

show_instruction = print_instructions("\nHave you played with this quiz before? ")
